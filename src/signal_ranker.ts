...
export const signals: Signal[] = [
  { lane: "FirstUp evidence coverage", risk: 72, savings: 21, investment: 61 },
...
console.log(JSON.stringify({ repo: "firstup-executive-comms-readiness-map", ranked: rank(signals) }, null, 2));
